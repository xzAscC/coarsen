...
def _transform_log_level(str_level):
    ...
    Parameters:
    - str_level (str): The input string representing the log level.
...
class LightLogging(object):
    def __init__(self, log_path=None, log_name="lightlog", log_level="debug"):
        ...
        Parameters:
            log_path (str): The path where the log files will be stored. Defaults to None.
            log_name (str): The name of the log file. Defaults to "lightlog".
